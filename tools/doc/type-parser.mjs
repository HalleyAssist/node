...
const customTypesMap = {
  ...
  'net.SocketAddressInit': 'net.html#socketaddressinit',

  'quic.ClientHello': 'quic.html#class-clienthello',
  'quic.Endpoint': 'quic.html#class-endpoint',
  'quic.EndpointConfig': 'quic.html#class-endpointconfig',
  'quic.EndpointConfigInit': 'quic.html#object-endpointconfiginit',
  'quic.EndpointStats': 'quic.html#class-endpointstats',
  'quic.OCSPRequest': 'quic.html#class-ocsprequest',
  'quic.OCSPResponse': 'quic.html#class-ocspresponse',
  'quic.ResponseOptions': 'quic.html#class-responseoptions',
  'quic.ResponseOptionsInit': 'quic.html#object-responseoptionsinit',
  'quic.Session': 'quic.html#class-session',
  'quic.SessionConfig': 'quic.html#class-sessionconfig',
  'quic.SessionConfigInit': 'quic.html#object-sessionconfiginit',
  'quic.SessionEvent': 'quic.html#class-sessionevent',
  'quic.SessionStats': 'quic.html#class-sessionstats',
  'quic.Stream': 'quic.html#class-stream',
  'quic.StreamOptions': 'quic.html#class-streamoptions',
  'quic.StreamOptionsInit': 'quic.html#object-streamoptionsinit',
  'quic.StreamStats': 'quic.html#class-streamstats',
